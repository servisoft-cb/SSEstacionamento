object fEstacionamentoMes: TfEstacionamentoMes
  Left = 383
  Top = 95
  Width = 731
  Height = 483
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'fEstacionamentoMes'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = True
        DataSource = dmEstacionamentoMes.dsEstacMes
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'VALOR M'#202'S'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'DIA_COBRANCA'
            Title.Caption = 'DIA COB.'
            Visible = True
          end
          item
            Expanded = False
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object SpeedButton2: TSpeedButton
          ...
          Width = 23
          Height = 22
          Hint = 'Atualiza pesquisa de pessoas'
          Glyph.Data = {
        ...
        object RxDBLookupCombo4: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = dmEstacionamentoMes.dsPessoa
          TabOrder = 2
        end
